...
export default function Hero() {
  ...
  return (
    ...
    <p className='lead mb-5 lg:mb-20' data-aos='fade-down' data-aos-delay='600'>{subtitle}</p>
    ...
    <button className='btn btn-md lg:btn-lg btn-accent flex justify-center items-center lg:gap-x-4'>{btnText}</button><span>{compText}</span>
    </div>
    </div>
